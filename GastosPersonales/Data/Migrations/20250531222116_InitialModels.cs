    ...
    public partial class InitialModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistroGastoEncabezados", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegistroGastoEncabezados_FondosMonetarios_FondoMonetarioId",
                        column: x => x.FondoMonetarioId,
                        principalTable: "FondosMonetarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RegistroGastoEncabezadoId = table.Column<int>(type: "int", nullable: false),
                    TipoGastoId = table.Column<int>(type: "int", nullable: false),
                    Monto = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistroGastoDetalles_RegistroGastoEncabezados_RegistroGastoEncabezadoId",
                        column: x => x.RegistroGastoEncabezadoId,
                        principalTable: "RegistroGastoEncabezados",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegistroGastoDetalles_TiposGasto_TipoGastoId",
                        column: x => x.TipoGastoId,
                        principalTable: "TiposGasto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistroGastoDetalles_RegistroGastoEncabezadoId",
                table: "RegistroGastoDetalles",
                column: "RegistroGastoEncabezadoId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistroGastoDetalles_TipoGastoId",
                table: "RegistroGastoDetalles",
                column: "TipoGastoId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistroGastoEncabezados_FondoMonetarioId",
                table: "RegistroGastoEncabezados",
                column: "FondoMonetarioId");
        }
